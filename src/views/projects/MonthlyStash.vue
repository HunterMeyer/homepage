        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full md:w-1/3">
            <div class="mb-5">
              ...
              <img src="/images/projects/logo-monthlystash.png" class="w-full pt-2" />
            </div>
            <div>
...
export default {
  ...
  computed: {
    currentStyle() {
      ...
      return this.darkMode ? styles.dark : styles.light
    }
  },
  methods: {
    toggleDarkMode() {
  ...
  styles:{
    light: {
      hero: {
        backgroundColors: ['#1e9650', '#a7fdc9'],
    ...
    dark: {
      hero: {
        backgroundColors: ['#1d0b35', '#140748'],
        titleColor: 'text-indigo-500',
        labelColor: 'text-indigo-700',
        swirlColor: '#21103e'
      },
      backgroundColor: '#21103e',
  ...
  metaInfo: {
    title: 'MonthlyStash',
    titleTemplate: '%s | ' + process.env.VUE_APP_TITLE + ' Projects'
  },
}
</script>
